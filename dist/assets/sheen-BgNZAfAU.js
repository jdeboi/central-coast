import{g as ue,l as ge,aJ as _e,R as Pe,U as be,aK as Se,s as le,L as ke,aL as Fe,V as m,ac as J,e as Le,d as Ie,u as We,v as Ne,w as qe,M as O,aM as Ue,y as Be,aN as Ce,q as De,aH as ze}from"./three.module-D0MAfM16.js";var Ve=Re;function Re(t,e,r){r=r||{};var a=r.octaveCount||4,n=r.amplitude||.1,c=r.persistence||.2,l=Te(t,e),f=new Array(a),i;for(i=0;i<a;++i)f[i]=x(i);var o=new Array(t*e),h=0;for(i=a-1;i>=0;--i){n*=c,h+=n;for(var d=0;d<o.length;++d)o[d]=o[d]||0,o[d]+=f[i][d]*n}for(i=0;i<o.length;++i)o[i]/=h;return o;function x(u){for(var y=new Array(t*e),s=Math.pow(2,u),b=1/s,w=0,p=0;p<e;++p)for(var M=Math.floor(p/s)*s,S=(M+s)%e,G=(p-M)*b,W=0;W<t;++W){var k=Math.floor(W/s)*s,H=(k+s)%t,N=(W-k)*b,q=Q(l[M*t+k],l[S*t+k],G),F=Q(l[M*t+H],l[S*t+H],G);y[w]=Q(q,F,N),w+=1}return y}}function Te(t,e){for(var r=new Array(t*e),a=0;a<r.length;++a)r[a]=Math.random();return r}function Q(t,e,r){return t*(1-r)+r*e}class Ae extends ue{constructor(e,r,a){const n={irradianceProbe:{value:e},radianceProbe:{value:r},iridescenceLookUp:{value:a},color:{value:new ge(1,1,1)},boost:{value:1}};super({uniforms:n,vertexShader:`
